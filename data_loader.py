...
if __name__ == '__main__':
    ...
    print
    train_title_word_input.shape, train_des_word_input.shape
    ...
    print
    tr_title_word_input.shape, tr_des_word_input.shape, tr_y.shape, tr_y_fa.shape

    print
    te_title_word_input.shape, te_des_word_input.shape, te_y.shape, te_y_fa.shape
